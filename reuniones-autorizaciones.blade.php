...
<div class="page-xl">
    ...
    <div class="auth-guide">
        ...
        <div>
            <strong>Como funciona:</strong> Cada panel representa un tipo de asignacion. Los publicadores dentro de un panel estan autorizados para esa parte. Usa el boton <strong>+</strong> de cada panel para agregar publicadores, o arrastra nombres entre paneles. Mover a <strong>Excluidos</strong> quita al publicador de todas las asignaciones.
        </div>
    </div>
